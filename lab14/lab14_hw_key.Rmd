...
```
> The scientists only genotyped the individuals that have the extreme phenotypes (the indivuals with very high blood pressure and very low blood pressure). Therefore, we see all the black lines concentrate in the middle.
...
iplotScanone(out.em)
```
> D4Mit164 has the highest LOD score, which is on chromosome 4.
...
> The gene marker with the highest LOD score 8.09 is D4Mit164. The individuals with the homozygous BB genotype have higher blood pressure comparing with the individuals with the heterozygous BA genotype.
