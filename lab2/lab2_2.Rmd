...
```{r}
my_vector_sequence_H <- seq(0, 100, by = 0.5)
my_vector_sequence_H
...
```{r}
harry_potter_matrix1 <- matrix(box_office)
harry_potter_matrix1
harry_potter_matrix2 <- matrix(box_office, nrow = 8, byrow = F)
...
```
```{r}
Deathly_Hallows_3 <- c(381.0,  90.5)
new_harry_potter_matrix <- rbind(harry_potter_matrix, Deathly_Hallows_3)
