...
### example 5: Looping over files for basic genetic analysis
The data is downloaded from [BACTERIAL BIOINFORMATICS RESOURCE CENTER](https://patricbrc.org/)
Please use standard R installation procedures to install the BiocManager package and then install "ShortRead" and "Biostrings". 
```{r message=FALSE, warning=FALSE}
...
### example 6: Looping over files for ggplot
```{r}
